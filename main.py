...
def task22():
    # x_set1 = set(map(int, input('Введите элементы множества через пробел: ').split()))
    x_set1 = set(randint(1, 9) for i in range(int(input("Введите количество элементов первого множества: "))))
    print(x_set1)
    # x_set2 = set(map(int, input('Введите элементы множества через пробел: ').split()))
    x_set2 = set(randint(1, 9) for i in range(int(input("Введите количество элементов второго множества: "))))
    print(x_set2)
    print(x_set1 & x_set2)
    # result = sorted(x_set1.intersection(x_set2))
    # print(f'Элементы двух множеств: {*result}')
